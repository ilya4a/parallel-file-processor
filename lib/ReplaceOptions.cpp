...
ReplaceOptions::Builder::Builder(std::string_view content, SearchResult const &search_result) : content_(content),
        search_result_(search_result),
        replacement_size_{0}, is_build(false) {
}
...
ReplaceOptions::ReplaceOptions(std::string &&replacement,
